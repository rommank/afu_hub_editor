                    ...
                    Row(
                      ...
                      children: [
                          ...
                          onPressed: () async {
                            ...
                            if (currentState.validate()) {
                              ...
                              TopicData updatedTopic = data.copyWith(
                                ...
                                endDate:
                                    TemporalDate(tempEndDate.copyWith(day: tempEndDate.day + 1)),
                              );
                              ...
                              if (sections.isNotEmpty) {
                                await ref
                                    ...
                                    .updateTopicIdForSections(topicId: topicId, sections: sections);
                              }
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () async {
                            await deleteTopic(context, ref, data).then((confirm) {
